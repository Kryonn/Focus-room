            ...
            <div className={styles.tool}>
                ...
                <button
                    onClick={() => {
                        ...
                        // Define popup label list, popup title and set popup state
                        setLabelList(["Name"]);
